...
import { Droplets, ShieldCheck, Mail, Lock, Loader2, ArrowRight } from 'lucide-react';
    ...
    return (
        <div className="min-h-[100dvh] bg-black text-white p-4 relative overflow-hidden flex items-center selection:bg-blue-500/30">
            ...
            <div className="absolute inset-0 z-0">
                ...
                <div className="absolute top-10 left-10 w-96 h-96 bg-blue-600/10 rounded-full blur-[100px] opacity-30" />
            ...
            <div className="max-w-md mx-auto w-full relative z-10">
                <div className="flex flex-col items-center mb-10 animate-in fade-in slide-in-from-top-4 duration-700">
                    ...
                    <h1 className="text-3xl font-black text-white tracking-tight">Lavage <span className="text-blue-500">Control</span></h1>
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        <div className="space-y-3">
                            ...
                            <Input
                                ...
                                placeholder="••••••••"
                                className="rounded-2xl h-14 bg-black/50 border-zinc-800 text-white focus-visible:ring-blue-500 focus-visible:border-blue-500 px-4 tracking-widest text-lg transition-all"
                                dir="ltr"
                                disabled={loading}
                            />
                        </div>
                        ...
                        <Button
                            type="submit"
                            className="w-full rounded-2xl h-14 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white text-lg font-black mt-8 shadow-[0_10px_20px_rgba(37,99,235,0.15)] transition-all hover:scale-[1.02] group"
