-- ============================================================
-- LAVAGETICKET — Complete Supabase Setup (v2)
...
GRANT EXECUTE ON FUNCTION get_people_ahead(UUID, TIMESTAMPTZ)            TO anon, authenticated;
GRANT EXECUTE ON FUNCTION process_next_customer(UUID)                    TO anon, authenticated;
